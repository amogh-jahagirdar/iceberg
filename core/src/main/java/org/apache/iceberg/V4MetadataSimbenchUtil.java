...
public class V4MetadataSimbenchUtil {
  ...
  V4ManifestEntry.EntryV4 generateManifest(Collection<V4ManifestEntry> entries, long sequenceNumber, OutputFile manifestOutputFile) {
    ...
    result.minSequenceNumber(sequenceNumber)
  ...
  public V4ManifestEntry.EntryV4 generateDataFileEntry(long sequenceNumber, String writeUUID, int taskId) {
  ...
  private class StatsGentVisitor
      extends TypeUtil.SchemaVisitor<V4ContentEntry.ContentStats> {

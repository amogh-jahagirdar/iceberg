...
4. Field ID 141 is reserved for spec_id representing the partition spec. Note that in practice spec_id is not written in the data file and 
is inherited from the manifest file.
